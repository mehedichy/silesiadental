...
Enter shortcode to the page where you want to display Facebook gallery and you are ready to go.
...
= 1.2 =
added scripts in footer to load website faster

= 1.3 =
errors fixed

= 1.4 =
made the plugin more easy and removed setting area