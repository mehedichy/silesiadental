...
if(count($WL_RG_Settings)) {
	...
	$WL_Hover_Color         = "rgba(0, 0, 0, 0.5)";
	$WL_Font_Style          = "Arial";
	$WL_Image_View_Icon     = "fa-expand";
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="wl-hover-color" id="wl-hover-color" value="#f0f8ff" <?php if($WL_Hover_Color == '#f0f8ff' ) { echo "checked"; } ?>> <span style="color: #74C9BE; font-size: large; font-weight: bolder;"><?php _e("Color 1", WEBLIZAR_RPG_TEXT_DOMAIN); ?></span>
                    <input type="radio" name="wl-hover-color" id="wl-hover-color" value="#f0f8ff" <?php if($WL_Hover_Color == '#f0f8ff' ) { echo "checked"; } ?>> <span style="color: #31A3DD; font-size: large; font-weight: bolder;"><?php _e("Color 2", WEBLIZAR_RPG_TEXT_DOMAIN); ?></span>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="wl-image-view-icon" id="wl-image-view-icon" value="fa-expand"  <?php if($WL_Image_View_Icon == 'fa-expand' ) { echo "checked"; } ?>> <i class="fa fa-picture-o fa-3x"></i>
...
<div class="col-sm-6 col-xs-4" style="width:49%;display:inline-block">
	...
	<img class="img-responsive" style="border: 1px solid #e3e3e3; background: #f7f7f7;padding:10px;width:100%" src="<?php echo WEBLIZAR_RG_PLUGIN_URL.'/images/nivo.jpg'?>" alt=""/>
</div>
<div class="col-sm-6 col-xs-4" style="width:49%;display:inline-block" >
	<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Photobox</h2>
	<img style="border: 1px solid #e3e3e3; background: #f7f7f7;padding:10px;width:100%" class="img-responsive" src="<?php echo WEBLIZAR_RG_PLUGIN_URL.'/images/photobox.jpg'?>" alt=""/>
</div>
<div class="col-sm-6 col-xs-4" style="width:49%;display:inline-block">
	<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Pretty Photo</h2>
	<img style="border: 1px solid #e3e3e3; background: #f7f7f7;padding:10px;width:100%" class="img-responsive" src="<?php echo WEBLIZAR_RG_PLUGIN_URL.'/images/prettyphoto.jpg'?>" alt=""/>
</div>
<div class="col-sm-6 col-xs-4" style="width:49%;display:inline-block">
	<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Swipe Box</h2>
	<img style="border: 1px solid #e3e3e3; background: #f7f7f7;padding:10px;width:100%" class="img-responsive" src="<?php echo WEBLIZAR_RG_PLUGIN_URL.'/images/swipebox.jpg'?>" alt=""/>
</div>
<?php
if(isset($_POST['wl_action'])) {
    ...
    if($Action == "wl-save-settings") {
        $WL_Hover_Animation     = sanitize_option( 'WL_Hover_Animation', $_POST['wl-hover-animation']);
        $WL_Gallery_Layout      = sanitize_option( 'WL_Gallery_Layout', $_POST['wl-gallery-layout']);
        $WL_Hover_Color         = sanitize_option( 'WL_Hover_Color', $_POST['wl-hover-color']);
        $WL_Font_Style          = sanitize_option( 'WL_Font_Style', $_POST['wl-font-style']);
        $WL_Image_View_Icon     = sanitize_option( 'WL_Image_View_Icon', $_POST['wl-image-view-icon']);
		$WL_Gallery_Title		= sanitize_option( 'WL_Gallery_Title', $_POST['wl-gallery-title']);
		$WL_Hover_Color_Opacity = sanitize_option( 'WL_Hover_Color_Opacity', $_POST['wl-hover-color-opacity']);
